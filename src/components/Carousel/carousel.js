...
const CarouselComponent = ({ siteTitle }) => (
    <Carousel>
        <Carousel.Item>
            ...
            />
            <Carousel.Caption>
            <img className="caption-top-bracket" src={topBracket} />
            ...
            <img className="caption-bottom-bracket" src={bottomBracket} />
            </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
            <img
            ...
            <img className="caption-top-bracket" src={bottomBracket} />
            </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
            <img
