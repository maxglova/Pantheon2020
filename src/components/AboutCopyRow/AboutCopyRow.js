    ...
    <div class="container">
      <div className="row half-content-spacer bottom-full-spacer">
        <div className="col-sm-6 about-non-contained-copy">
          ...
          <a className="textLink-wArrow small-content-spacer" href="#">Manage Sessions <img src={blueArrow} /></a>
        </div>
        ...
        <div className="col-sm-4">
          ...
          <img className="aboutDetailsRightDashedLines" src={rightDashedLines} />
          <img className="aboutDetailsBottomDashedLines" src={bottomDashedLines} />
        </div>
      </div>
    </div>
