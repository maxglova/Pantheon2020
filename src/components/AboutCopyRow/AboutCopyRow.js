    ...
    <div class="container">
      <div className="row half-content-spacer bottom-full-spacer">
        <div className="col-sm-6 about-non-contained-copy">
          ...
          <a className="textLink-wArrow small-content-spacer" href="/pantheon/agenda">Manage Sessions <img src={blueArrow} alt="Link Arrow"/></a>
        </div>
        ...
        <div className="col-sm-4">
          <div className="aboutDetailsWrapper">
            ...
            <div className="aboutDetailsBorderContainer">
              <div className="aboutDetailsContainer">
                <img className="detailsIcon" src={calendarIcon} alt="calendar"/>
              ...
              <div className="aboutDetailsContainer">
                <img className="detailsIcon" src={locationIcon} alt="location"/>
                <div className="aboutDetailsCopy">
              ...
              <div className="aboutDetailsContainer">
                <img className="detailsIcon priceIconPad" src={priceIcon} alt="price"/>
                <div className="aboutDetailsCopy">
              ...
              <div className="aboutDetailsContainer">
                <img className="detailsIcon" src={infoIcon} alt="information"/>
                <div className="aboutDetailsCopy">
                  <p className="boldedAboutDetailsHead bold-upper-head">Price</p>
                  <p>Starting at $999</p>
                </div>
          ...
          <img className="aboutDetailsRightDashedLines" src={rightDashedLines} alt="border"/>
          <img className="aboutDetailsBottomDashedLines" src={bottomDashedLines} alt="border"/>
        </div>
      </div>
    </div>
